                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            while ($sections = mysqli_fetch_object($query)) { ?>
                                ...
                                <div>
                                    <label for="<?= $count ?>">
                                        <input type="checkbox" id="<?= $count ?>" value=" <?= $sections->title ?>" name="section[]" placeholder="Section"
                                            >
                                        <?= $sections->title ?>
                                    </label>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        //     $sec_query = mysqli_query($db_conn,'SELECT * FROM sections WHERE
                                        //     id='.$section.'');
                                        //     $sec = mysqli_fetch_object($sec_query);
                                        //     echo $sec-> title.'<br>';
                                        // }
                                        print_r($class-> section .'<br>');
                                        ?>
                                    </td>
                                    <td></td>
                                </tr>
